define(["require", "exports", "lib/gaia/router/GaiaRoute", "lib/gaia/router/RouteResultItem"], function (require, exports, GaiaRoute_1, RouteResultItem_1) {
    /**
                        ...
                        if (isLanding && route.hasLandingRedirect()) {
                            ...
                            if (includeRedirects) {
                                ...
                                route.resolveLandingRedirect(route.getAction().getPage(url, route, includeRedirects), function (redirectTo) {
                                    ...
                                    if (redirectTo == url) {
                                        console.warn('[GaiaRouteGroup] we have spotted a recursive redirect!');
