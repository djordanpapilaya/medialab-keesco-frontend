define(["require", "exports", "lib/temple/config/configManagerInstance", "lib/gaia/api/Gaia", "app/data/enum/Branches", "app/data/enum/Param"], function (require, exports, configManagerInstance_1, Gaia, Branches_1, Param_1) {
    /**
    ...
    var Routes = (function () {
        ...
        Routes.init = function () {
            ...
            // config setup
            Gaia.router.config()
                .assert(Param_1.default.ID, UINT)
